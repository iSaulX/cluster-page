...
export default function AddComputer(){
    ...
    return (
        <>
            ...
            <Button isIconOnly onPress={onOpen} className=' bg-blue-400'><svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12H20M12 4V20" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg></Button>
            </div>
                ...
                <ModalContent>
                    {(onClose: ((e: PressEvent) => void) | undefined) => {
                        const registerComputer = async() => {
                            setIsLoading(true);
                            fetch('http://127.0.0.1:8080/addComputer', {
                                method: 'POST',
                                headers: {
